...
export class SaveManager {
  ...
  public getDefaultData(): GameSaveData {
    ...
    return {
      ...
      ownedVehicleIds: ['opel_corsa_b', 'starter_coupe', 'tofas_gltf', 'golf_gti', 'mini_cooper', 'bmw_e46'],
  ...
  private migrate(raw: Partial<GameSaveData>): GameSaveData {
    ...
    const freeGarageCars = ['opel_corsa_b', 'starter_coupe', 'tofas_gltf', 'golf_gti', 'mini_cooper', 'bmw_e46'];
